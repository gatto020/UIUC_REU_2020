...
function I3(density_matrix,n) #n is the total number of qubits
    if (n == 3)
        marginal_AB = QBase.partial_trace(density_matrix,[2,2,2],3)
        marginal_BC = QBase.partial_trace(density_matrix,[2,2,2],1)
        marginal_AC = QBase.partial_trace(density_matrix,[2,2,2],2)
        marginal_A = QBase.partial_trace(marginal_AB,[2,2],2)
        marginal_B = QBase.partial_trace(marginal_BC,[2,2],2)
        marginal_C = QBase.partial_trace(marginal_AC,[2,2],1)
    ...
    elseif(n == 6)
        marginal_AABB = QBase.partial_trace(QBase.partial_trace(density_matrix,[2,2,2,2,2,2],6),[2,2,2,2,2],5)
        marginal_BBCC = QBase.partial_trace(QBase.partial_trace(density_matrix,[2,2,2,2,2,2],1),[2,2,2,2,2],1)
        marginal_AACC = QBase.partial_trace(QBase.partial_trace(density_matrix,[2,2,2,2,2,2],3),[2,2,2,2,2],3)
        marginal_AA = QBase.partial_trace(QBase.partial_trace(marginal_AABB,[2,2,2,2],4),[2,2,2],3)
        marginal_BB = QBase.partial_trace(QBase.partial_trace(marginal_BBCC,[2,2,2,2],4),[2,2,2],3)
        marginal_CC = QBase.partial_trace(QBase.partial_trace(marginal_AACC,[2,2,2,2],1),[2,2,2],1)
